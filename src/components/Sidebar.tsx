...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const getCategoryButtonClass = (category: string | null) => {
    ...
    const selectedClass = selectedCategory === category
  ...
  return (
    <div className={`fixed top-0 left-0 h-full bg-white shadow-lg transition-all duration-300 ease-in-out z-30 ${
      isOpen ? 'w-64' : 'w-16'
    }`}>
      {/* Toggle Button */}
      <button
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200 bg-white">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={isOpen ? "Search by date..." : ""}
              value={searchQuery}
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-4 space-y-2">
            <h2 className={`text-lg font-semibold text-gray-900 mb-4 ${!isOpen && 'hidden'}`}>
              Categories
            </h2>
